...
int main()
{
    tData prox_data = {1, 1, 1}, data1 = {1, 1, 1}, data2 = {1, 1, 1};

    data1 = LeData();
    if (EhDataValida(data1))
    {
        ImprimeData(data1);
    }
    else
    {
        data1 = AlteraData(data1);
        ImprimeData(data1);
    }
    ...
    while (1)
    {
        prox_data = ProxData(data1);
        if(EhDataIgual(prox_data, data2)) {
            break;
        }
        ImprimeData(prox_data);
        data1 = prox_data;
    }
